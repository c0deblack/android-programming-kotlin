...
const val CHEAT_COUNT_KEY = "CHEAT_COUNT_KEY"
const val CHEAT_COUNT_REMAINING = "CHEAT_COUNT_REMAINING_KEY"
...
/***************************************************************************************************
 * Challenge #13: Limit Cheats.
 *      These variables enable the app to limit the number of cheats users can perform.
 **************************************************************************************************/
    var cheatCount: Int
        get() = savedStateHandle[CHEAT_COUNT_KEY] ?: 0
        set(value) = savedStateHandle.set(CHEAT_COUNT_KEY, value)
    var cheatsRemaining: Int
        get() = savedStateHandle[CHEAT_COUNT_REMAINING] ?: MAX_CHEAT_COUNT
        set(value) = savedStateHandle.set(CHEAT_COUNT_REMAINING, value)
/***************************************************************************************************
 * Getters
...
/***************************************************************************************************
 * Modify Cheat Count Variables
 * Challenge #13: Limit Cheats
 *      Handles updating the cheat count variables.
 * NOTE: MUST be called before [QuizViewModel.setQuestionCheatStatus]
 **************************************************************************************************/
   fun updateCheatCount(){
        if(!questionBank[currentIndex].cheated){
            cheatCount++
            if(cheatsRemaining > 0) cheatsRemaining -= 1
        }
   }
}