...
import com.c0deblack.bignerdranch.androidprogramming.databinding.Ch12LayoutListItemCrimeBinding
import com.c0deblack.bignerdranch.androidprogramming.databinding.Ch12LayoutListItemPoliceBinding
 ...
 **************************************************************************************************/
class CrimeHolder(
    val binding: Ch12LayoutListItemCrimeBinding
) : BaseHolder(binding) {
/***************************************************************************************************
...
class PoliceViewHolder (
    val binding: Ch12LayoutListItemPoliceBinding
) : BaseHolder(binding) {
/***************************************************************************************************
 * Bind crime data to the item view used in the [RecyclerView].
 * @param crime a single [Crime] instance.
 ...
 **************************************************************************************************/
    override fun onCreateViewHolder(
        ...
        return if (viewType == requiresPoliceViewType) {
            val binding = Ch12LayoutListItemPoliceBinding.inflate(inflater, parent, false)
            PoliceViewHolder(binding)
        } else {
            val binding = Ch12LayoutListItemCrimeBinding.inflate(inflater, parent, false)
            CrimeHolder(binding)
        }
    }
/***************************************************************************************************
