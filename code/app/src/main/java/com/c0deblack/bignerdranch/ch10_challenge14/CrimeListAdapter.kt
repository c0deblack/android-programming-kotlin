...
import com.c0deblack.bignerdranch.androidprogramming.databinding.Ch10LayoutChallenge14ListItemCrimeBinding
import com.c0deblack.bignerdranch.androidprogramming.databinding.Ch10LayoutChallenge14ListItemPoliceBinding
 ...
 **************************************************************************************************/
class CrimeHolder(
    val binding: Ch10LayoutChallenge14ListItemCrimeBinding
) : BaseHolder(binding) {
/***************************************************************************************************
...
class PoliceViewHolder (
    val binding: Ch10LayoutChallenge14ListItemPoliceBinding
) : BaseHolder(binding) {
/***************************************************************************************************
 * Bind crime data to the item view used in the [RecyclerView].
 * @param crime a single [Crime] instance.
 ...
 **************************************************************************************************/
    override fun onCreateViewHolder(
        ...
        return if (viewType == requiresPoliceViewType) {
            val binding = Ch10LayoutChallenge14ListItemPoliceBinding.inflate(inflater, parent, false)
            PoliceViewHolder(binding)
        } else {
            val binding = Ch10LayoutChallenge14ListItemCrimeBinding.inflate(inflater, parent, false)
            CrimeHolder(binding)
        }
    }
/***************************************************************************************************
