...
import com.c0deblack.bignerdranch.androidprogramming.databinding.Ch08LayoutChallenge13Binding
 ...
 **************************************************************************************************/
    private val cheatLauncher = registerForActivityResult(
        ...
        if(quizViewModel.isCheater) {
            // --- Challenge #13: Limit Cheats
            // --- Update cheat counts and then disable cheat button if required.
            // --- MUST be called before quizViewModel.setQuestionCheatStatus()
            quizViewModel.updateCheatCount()
            setCheatButtonState()
            setCheatCounts()
...
/***************************************************************************************************
 * Set Cheat Button Enabled State.
 * Challenge #13: Limit Cheats
 *      Disable the cheat button if the max number of cheats has been reached.
 **************************************************************************************************/
    private fun setCheatButtonState(){
        if(quizViewModel.cheatsRemaining == 0) {
            setViewIsEnabled(false, binding.cheatButton)
        }
    }
/***************************************************************************************************
 * Set Cheat Count Text.
 * Challenge #13: Limit Cheats.
 ...
 * The annotation declares this code can only run on API level 31 (Version_Codes.S) or higher
 **************************************************************************************************/
